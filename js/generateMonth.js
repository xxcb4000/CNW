    ...
    for (let i = 1; i<=nombreDeJours ; i++) {
        ...
        switch (i) {
            case jourFacile :
                ...
                lienFacile.href =`mesoptions${saison}.html?mois=${mois}&level=jourFacile`;
            ...
            case jourIntermediaire :
                ...
                lienIntermediaire.href =`mesoptions${saison}.html?mois=${mois}&level=jourIntermediaire`;
            ...
            case jourDifficile :
                ...
                lienDifficile.href =`mesoptions${saison}.html?mois=${mois}&level=jourDifficile`;
